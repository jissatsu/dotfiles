...
bool QuickMenu::init_cursor( void )
{
    
}

bool QuickMenu::init_layout( void )
{
...
void QuickMenu::add_commands( void )
{
    
}

void QuickMenu::add_command( std::string text, float size, float y_offset, 
